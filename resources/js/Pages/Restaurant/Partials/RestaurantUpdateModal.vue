...
function update() {
    form.patch(route('restaurants.update', props.restaurant.id),
        {
            onSuccess: () => {
                restaurantStore.showEditModal = false;
...
<template>
    <i @click="restaurantStore.showEditModal = true" class="fa-solid fa-pen-to-square fa-lg text-yellow"></i>

    <Modal :show="restaurantStore.showEditModal" max-width="2xl" @close="restaurantStore.showEditModal = false">
        <form @submit.prevent="update" class="mx-10 pt-10 pb-8" enctype="multipart/form-data">
            ...
            <div class="mt-4">
                ...
                <TextInput
                    ...
                    :placeholder="props.restaurant.table_amount"
            ...
            <div class="mt-4">
                ...
                <FileInput
                    id="bg_img_url"
                    @change="form.bg_img_url = $event.target.files[0]"
                    class="mt-1 block w-full"
            ...
            <div class="mt-4">
                ...
                <FileInput
                    ...
                    @update:placeholder="form.logo_url = $event.target.files[0]"
            ...
            <div class="flex gap-5">
                <div class="grow mt-4">
                    ...
                    <TextInput
                        ...
                        :placeholder="props.restaurant.home_address"
                ...
                <div class="grow mt-4">
                    ...
                    <TextInput
                        ...
                        :placeholder="props.restaurant.street_address"
            ...
            <div class="flex gap-5">
                <div class="grow mt-4">
                    ...
                    <TextInput
                        ...
                        :placeholder="props.restaurant.commune"
                ...
                <div class="grow mt-4">
                    ...
                    <TextInput
                        ...
                        :placeholder="props.restaurant.district"
