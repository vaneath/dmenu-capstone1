<template>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 mt-3 gap-3">
        <div class="w-full">
            <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                ...
                <div class="mx-5">
                    <h4 class="text-2xl font-semibold text-gray-700" v-text="props.statistics.total_restaurants"></h4>
        ...
        <div class="w-full">
            <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                ...
                <div class="mx-5">
                    <h4 class="text-2xl font-semibold text-gray-700" v-text="props.statistics.total_orders"></h4>
        ...
        <div class="w-full">
            <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                ...
                <div class="mx-5">
                    <h4 class="text-2xl font-semibold text-gray-700" v-text="`$${props.statistics.revenue}`"></h4>
                    <div class="text-gray-500">Daily Income</div>
                </div>
            </div>
        </div>
        <div class="w-full">
        ...
        <template v-for="(total, name) in props.statistics.avg_invoice_total_by_restaurant" :key="name">
            <div class="flex px-6 py-4 w-52 gap-3 bg-white rounded-md">
                <img class="w-20 h-20"
                     ...
                     alt="">
                <div>
                    <div class="font-bold text-xl mb-2" v-text="name"></div>
                    <p class="text-gray-700 text-base" v-text="total ? '$' + total.toFixed(2) : '$0'"></p>
                </div>
            </div>
        </template>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mt-5">
        <template v-for="item in props.statistics.most_ordered_item">
            <div class="mx-auto flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                ...
                <div class="flex flex-col justify-between p-4 leading-normal">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white" v-text="item.name"></h5>
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400" v-text="item.description"></p>
                </div>
            </div>
        </template>
    </div>
