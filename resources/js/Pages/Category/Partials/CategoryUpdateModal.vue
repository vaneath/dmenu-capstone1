...
function update() {
    ...
    form.patch(route('categories.update', props.category.id), {
        onSuccess: () => {
            categoryStore.showEditModal = false;
...
<template>
    <i @click="categoryStore.showEditModal = true" class="fa-solid fa-pen-to-square fa-lg text-yellow cursor-pointer"></i>

    <Modal :show="categoryStore.showEditModal" max-width="md" @close="categoryStore.showEditModal = false">
