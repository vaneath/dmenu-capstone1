...
<div x-data="{ open: false,
  ...
  <div x-show="createCategoryFormOpen" class="fixed inset-0 items-center justify-center mt-24 max-w-2xl mx-auto overflow-x-hidden overflow-y-auto z-50">
        ...
        <div class="bg-white w-full p-6 text-wrap break-words flex flex-col" style="max-height: 80vh; overflow-y: auto">
          ...
          <form @submit.prevent="submit" action="/categories" method="POST" x-data="{  }">
            ...
            <div class="flex flex-col mb-4">
              ...
              <input @blur="validateName" class="border border-gray-300 rounded-md px-3 py-2" type="text" placeholder="Desserts" name="name" x-model="inputValues.name" />
...
<input type="hidden" name="section_id" value="{{ $section->id }}" />
    ...
    <div x-show="createCategoryFormOpen" class="absolute z-40 inset-0 bg-black bg-opacity-50"></div>
