                ...
                <div class="bg-white w-full p-6 text-wrap break-words flex flex-col"
                    ...
                    <form @submit.prevent="submit" action="/categories" method="POST" x-data="{  }" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-col mb-4">
                            ...
                            <x-form.text-input @blur="validateName" placeholder="Desserts" name="name"
                                               x-model="inputValues.name"/>
                        ...
                        <div class="inline-flex items-center">
                            ...
                            >
                                ...
                                />
                                <div
                                    class="pointer-events-none absolute top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4 text-gray-700 opacity-0 transition-opacity peer-checked:opacity-100">
                                    <svg
                        ...
                        <div class="flex justify-center space-x-4">
                            <button type="button" class="bg-red-500 text-white rounded-lg px-6 py-2"
                                    @click="createCategoryFormOpen = false">
                                Close
                            </button>
