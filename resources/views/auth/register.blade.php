<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
        <div>
            <x-form.input-label class="text-white" for="name" :value="__('Name')" />
        ...
        <!-- Email Address -->
        <div class="mt-4">
            <x-form.input-label class="text-white" for="email" :value="__('Email')" />
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-form.input-label class="text-white" for="password" :value="__('Password')" />
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-form.input-label class="text-white" for="password_confirmation" :value="__('Confirm Password')" />
