@extends('superadmin._layouts.master')
...
@section('body')
    ...
    <h3 class="mt-8 text-gray-700 text-3xl font-medium">Active Restaurant</h3>
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm leading-5 font-medium text-gray-900">Vaneath Restaurant</div>
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <div class="text-sm leading-5 text-gray-900">Vaneath</div>
                            <div class="text-sm leading-5 text-gray-500">3 restaurants</div>
                        </td>
