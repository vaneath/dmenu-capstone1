...
<x-head>
    ...
    <body class="min-h-screen font-sans text-gray-900 antialiased">
        <div class="flex mt-10 flex-col sm:justify-center items-center pt-6 sm:pt-0">
            <div class="w-full mt-6 px-10 py-10 bg-blue shadow-md overflow-hidden rounded-xl">
                {{ $slot }}
            </div>
        </div>
    </body>
