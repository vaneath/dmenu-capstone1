<header class="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-yellow">
    ...
    <div class="flex items-center">
        ...
        <a href="{{ route('profile.edit') }}" class="relative my-auto block w-8 h-8 overflow-hidden rounded-full shadow focus:outline-none">
